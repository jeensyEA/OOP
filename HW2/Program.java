...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        Cat catChubik = new Cat("Граф", 10);
        Cat catPepsik = new Cat("Персик", 15);
        Cat catYuki = new Cat("Гаф", 6);
        Cat catViska = new Cat("Вискас", 5);
        Cat catLastya = new Cat("Шива", 7);

        ArrayList<Cat> myCats = new ArrayList<>();
        myCats.add(catGraf);
        myCats.add(catPersik);
        myCats.add(catGaf);
        myCats.add(catViskas);
        myCats.add(catShiva);
